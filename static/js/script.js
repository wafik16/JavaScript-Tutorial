...
var all_buttons = document.querySelectorAll("[id='button-change']");
...
function blackjackHit() {
    if (blackjackGame['isStand'] === false) 
    {
        ...
        showScore(YOU);
        blackjackGame['HasUserPlayed'] = true;
    }
}
...
function blackjackDeal() {
    ...
    blackjackGame['HasUserPlayed'] = false;
...
async function dealerLogic() {
    if (blackjackGame['turnsOver'] == false) 
    {
        ...
        if (blackjackGame['HasUserPlayed'] == true)
        {
...
function computeWinner() {
    ...
    if (YOU['score'] <= 21) {
        ...
        //condition: when user burst and dealer dosent
    } else if (YOU['score'] > 21 && DEALER['score'] <= 21) {
        blackjackGame['losses']++;
        winner = DEALER;

    // condition: when you and dealer busrt
    } else if (YOU['score'] > 21 && DEALER['score'] > 21) {
        blackjackGame['draws']++;
    }
    return winner;
